...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        compares two rectangles of an instance Rectangle \
                by virtue of area and return the biggest 
        """
    ...
    def square(cls, size=0):
        """
        return a new Rectangle instance of width == height == size
        """
        cls.check_value(size, 'size')
        cls.__height = size
        cls.__width = size
